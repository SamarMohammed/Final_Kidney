...
/*		if (mysqli_errno($con)) 
		...
		$check = mysqli_query($con,"SELECT * FROM patient WHERE email = '$to'")or die(mysql_error());
		...
		if ( ($error2=="") && ($msgs_pass=="")&&($msg_pass=="")&&($msg2s_pass=="")&&($msg2_pass2=="")&&($msg3_pass2=="" )) 
		{
				...
				$sql = mysqli_query($con,"UPDATE patient SET email='$email', blood='$gender', tissue='$user' WHERE email = '$to'")or die (mysql_error());
