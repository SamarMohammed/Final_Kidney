...
if ($_SERVER["REQUEST_METHOD"] == "POST")
{
	...
	if($msg2_agree == "" && $msg_agree=="" && $msgs_name=="" && $msg_name=="" && $msg2s_name=="" && $msg2_name=="" && $msgs_email=="" && $msg_email=="" && $msg2_email=="")
	{
			...
			$te="SELECT * FROM `patient` WHERE email='$email'";
			...
			else
			{
				...
				header("location:match.php?user=".$user."&gender=".$gender."&email=".$email."&bday=".$bday);
    ...
    <ul>
        ...
        <br>
                  <br>
					...
					<a href="edit2.php" style="color:red">EDIT YOUR FORM</a>
