...
// checks if the username is in use
	$check = mysqli_query($con,"SELECT * FROM donator WHERE email = '$email'")or die(mysql_error());
...
// if no errors then carry on
	if (($error == "") && ($error2 == "" )) {
		...
		$query = mysqli_query($con,"SELECT * FROM donator WHERE email = '$email' ")or die (mysql_error());
              ...
              <div class="col-md-6 col-md-offset-3"><br><br><br><br><br>
					<form action="<?php $_SERVER['PHP_SELF']?>" method="post" autocomplete="on">
					    <?php if ($rsent == true){
					           ...
					           echo"<a href=\"change.php?email=$to\">Click Here To Edit You Form</a>";
